  ...
  return (
    <div className="admin-dashboard-container">
      ...
      <nav className="admin-nav">
        ...
        <Link to="/admin/skillsets" className="nav-link">Skillsets</Link>
        <Link to="/admin/managers" className="nav-link">Managers</Link>
        <Link to="/admin/employeeskills" className="nav-link">Employee Skills</Link>
